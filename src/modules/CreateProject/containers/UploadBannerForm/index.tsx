...
import ProjectDescriptionEditor from 'src/modules/General/components/RichTextEditor';
...
const UploadBannerForm: React.FC = () => {
  ...
  return (
    <form>
      <div className="flex flex-col justify-center align-middle md:h-[560px] h-full">
        <div>
