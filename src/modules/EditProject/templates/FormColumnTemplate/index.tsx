  ...
  return (
    ...
    >
      <div className="w-full md:w-[280px] flex flex-col">
        <div className="text-[18px] font-medium leading-7 text-secondary-700">{title}</div>
        {subtitle && <div className="text-[16px] font-normal leading-6 text-tertiary-600">{subtitle}</div>}
      </div>
