  ...
  const signupOptions = [
    {
      ...
      title: 'Individual',
      description: 'Vote and donate for projects',
    },
    {
      id: '2',
      value: 'org',
      ...
      title: 'Organization',
      description: 'Create your project in minutes and get funded',
    },
  ];
  ...
  return (
    <div className="h-[100vh] flex gap-6 p-6">
        ...
        <div className="h-full max-w-[22.5rem]ّ flex flex-col justify-between md:justify-center">
          <div className="flex flex-col items-center justify-center gap-6">
            ...
            <div className="mt-2">
              ...
              <Link href="/test" label="Log in" customStyle="!font-semibold" />
            </div>
          </div>
      ...
      <div className="flex-1 hidden md:block overflow-hidden rounded-2xl">
        <img src="/images/intro.svg" alt="SIF Intro" width="100%" className="object-cover" />
      </div>
    </div>
  );
};
