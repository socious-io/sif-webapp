...
export const SelectIdentity = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white md:bg-Gray-light-mode-50">
      <div className="w-full max-w-[440px] flex flex-col gap-6 p-8 px-10 rounded-[12px] md:shadow-sm bg-white">
        <img alt="logo" className="w-[40px] self-center" src={logo} />

        <h1 className="text-Wild_blue-900 text-center font-inter text-xl font-semibold leading-8">
          {translate('select-identity-create-title')}
        </h1>
        <p className="text-Gray-light-mode text-sm font-normal leading-5 text-left">
        ...
        <ol className="text-Gray-light-mode text-sm font-normal leading-5 space-y-2 list-decimal list-inside text-left">
